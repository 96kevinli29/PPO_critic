#!/bin/bash
# Qwen3-8B PPO with MATH-Lighteval (Rule-based Reward)
...
# 模型路径
MODEL_PATH="/data_storage/lixiao/research_proj_xiao/hyl/Qwen3-8B"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3_8b_ppo_math_lighteval' \
